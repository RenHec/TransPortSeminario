  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('transport-machinary.update', ['id' => $data->id]) }}">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <input id="name" type="text" class="form-control" placeholder="honda / civic" name="name" value="{{ $data->name }}" maxlength="75" required autofocus>
                  @if ($errors->has('name'))
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                ...
                <input type="file" class="=form-control" id="avatar" name="avatar" accept=".png, .jpg" autofocus>
              </div>
              <div class="col-md-3">
                <label for="model" class="control-label"><label style="color:red">*</label> Modelo</label>
                <input id="model" type="text" class="form-control" placeholder="1900" name="model" value="{{ $data->model }}" onkeypress="return numero(event)" maxlength="4" required autofocus>
                  @if ($errors->has('model'))
             ...
             <div class="col-md-2">
                ...
                <input id="km" type="text" class="form-control" placeholder="1900" name="km" value="{{ $data->km }}" onkeypress="return numero(event)" maxlength="10" required autofocus>
                  @if ($errors->has('km'))
