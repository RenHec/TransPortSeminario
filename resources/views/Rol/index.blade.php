...
@section('action-content')
    ...
    <section class="content">
            ...
            <!--Boton para Agregar-->
              <div class="form-group">
                <div class="col-md-7 col-md-offset-5">
                  <a class="btn btn-primary" href="{{ route('transport-rol.create') }}"><i class="glyphicon glyphicon-plus-sign"></i> Nuevo</a>
                </div>
              </div>
        @endcomponent
      ...
      <form method="POST" action="{{ route('transport-rol.search') }}">
         {{ csrf_field() }}
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead >
              <tr role="row">
                <th width="8%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Organizacion</th>
                <th width="10%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Nombre</th>
            ...
            @foreach ($dats as $data)
                <tr role="row" class="odd">
                  <td class="sorting">{{ $data->organitation }}</td>
